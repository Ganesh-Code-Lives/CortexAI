...
const addCover = (ppt, data) => {
    ...
    slide.addText(data.title, {
        ...
        align: "center", color: COLORS.white, bold: true, fontSize: 28,
    })

    slide.addText(data.subtitle, {
        x: 1, y: 2.8, w: 11.5, h: 0.4,
        align: "center", color: "DBEAFE", fontSize: 15,
    })
...
function addContentSlide(ppt, title, points, page, total) {
    ...
    visiblePoints.forEach((point, i) => {
        ...
        slide.addShape(ppt.ShapeType.ellipse, {
            x: 0.92, y: y + 0.18, w: 0.12, h: 0.12,
            fill: { color: COLORS.primary },
            line: { color: COLORS.primary },
        })

        slide.addText(point, {
            x: 1.2, y: y + 0.08, w: 11, h: 0.35,
            fontSize: 15, color: COLORS.text, fit: "shrink",
        })
    })
...
const addThankYou = (ppt) => {
    ...
    slide.addText("Thank You", {
        ...
        align: "center", color: COLORS.white, fontSize: 34, bold: true,
    })
